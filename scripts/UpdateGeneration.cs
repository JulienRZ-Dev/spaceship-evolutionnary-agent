...
public class UpdateGeneration
{
    ...
    public Kevin[] CreateGeneration()
    {
        ...
        else
        {
            ...
            {
                children[i] = new Kevin(9, 20, 3, mutationProba, mutationIntensity);
            }
            return children;
        }
    }
    ...
    private Kevin[] SelectGeneration()
    {
        ...
        {
            children[cpt] = new Kevin(9, 20, 3, mutationProba, mutationIntensity);
            cpt++;
        }
    ...
    private void GetBestsFromFile()
    {
        ...
        for (int i = 0; i < nbBest; i++)
        {
            bests[i] = new Kevin(7, 20, 3, flatBestWeights[i], flatBestBiases[i], mutationProba, mutationIntensity);
        }
    }
